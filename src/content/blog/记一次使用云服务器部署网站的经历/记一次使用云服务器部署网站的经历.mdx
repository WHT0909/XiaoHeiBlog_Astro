...
heroImage: { src: './picture.jpg', alt: 'Web', color: '#B4C6DA' }
...
<font size="2">封面画作：Alfred Sisley ***The Bridge at Villeneuve-la-Garenne***(1872)</font>
...
![查看控制台](./查看控制台.png)
<p style="text-align:center;">查看控制台</p>
